...
const sections: Section[] = [
  {
    ...
    content:
      'NuScript Technologies Private Limited ("NuScript", "we", "us", or "our") operates the MedScribeAI platform (medscribeai.in and app.medscribeai.in). This Privacy Policy describes how we collect, use, store, and protect information when you use our services.',
  },
  {
    ...
    items: [
      {
        ...
        text: "When you register for MedScribeAI, we collect your name, email address, phone number, company name, and role.",
      },
      {
        label: "Usage Data",
  ...
  },
  {
    ...
    content:
      "We use collected information to provide and improve the MedScribeAI platform, process medical transcriptions through our AI pipeline, manage workforce functions as configured by the customer, generate analytics and reporting, communicate service updates and support, and comply with legal obligations.",
  },
  {
  ...
  },
  {
    ...
    content:
      "MedScribeAI uses third-party services for core functionality including speech-to-text processing, AI document formatting, cloud hosting, file storage, database management, and user authentication. Each provider maintains its own privacy policies and security certifications.",
  },
  {
