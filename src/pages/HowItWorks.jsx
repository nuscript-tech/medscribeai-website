    ...
    <div className="min-h-screen bg-white" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <section className="relative pt-32 pb-16 bg-white overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <span className="text-sm font-bold text-brand uppercase tracking-wider">How It Works</span>
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-brand-navy mt-4 mb-6 leading-[1.1]">
              From Audio to Approved Document<br/><span className="text-brand">in 7 Steps</span>
            </h1>
      ...
      <section className="py-16 bg-brand-cool-gray">
        <div className="max-w-4xl mx-auto px-6">
          <div className="relative">
            {/* Vertical line */}
            <div className="absolute left-6 sm:left-8 top-0 bottom-0 w-px bg-brand/20 hidden sm:block" />
              ...
              {steps.map((step, i) => (
                <motion.div key={i} initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }}
                  ...
                  <div className="relative z-10 flex-shrink-0">
                    <div className="w-12 h-12 sm:w-16 sm:h-16 bg-brand rounded-xl flex items-center justify-center shadow-lg shadow-brand/20">
                      <step.icon className="w-6 h-6 sm:w-7 sm:h-7 text-white" />
                    </div>
                  </div>
                  <div className="bg-white rounded-xl p-6 sm:p-8 border border-gray-200 flex-1 hover:border-brand/20 transition-colors">
                    <div className="flex items-center gap-3 mb-3">
                      <span className="text-xs font-bold text-brand bg-brand-light px-2.5 py-1 rounded-full">{step.tag}</span>
                    ...
                    <p className="text-brand-text leading-relaxed">{step.desc}</p>
                  </div>
                </motion.div>
              ))}
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-5xl mx-auto px-6">
          <div className="bg-gradient-to-br from-brand-light to-brand-cool-gray rounded-2xl p-8 sm:p-12 border border-brand-light">
            <div className="flex items-start gap-5">
              <div className="w-14 h-14 bg-brand rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg shadow-brand/20">
                <RotateCcw className="w-7 h-7 text-white" />
              </div>
              <div>
                <h2 className="text-2xl sm:text-3xl font-extrabold text-brand-navy mb-4">The Self-Improving Learning Loop</h2>
      ...
      <section className="py-16 bg-brand">
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-brand-light max-w-3xl mx-auto mb-8">
