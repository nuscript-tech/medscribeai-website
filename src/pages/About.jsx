...
export default function About() {
  return (
    <div className="min-h-screen bg-white" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <section className="relative pt-32 pb-16 bg-white overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <span className="text-sm font-bold text-brand uppercase tracking-wider">About MedScribeAI</span>
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-brand-navy mt-4 mb-6 leading-[1.1]">
              We Run an MTSO.<br/>
              <span className="text-brand">We Built What We Needed.</span>
            </h1>
      ...
      {/* Values */}
      <section className="py-20 bg-brand-cool-gray">
          ...
          <div className="grid sm:grid-cols-2 gap-8">
            {values.map((v, i) => (
              <motion.div key={i} initial={{ opacity: 0, y: 15 }} whileInView={{ opacity: 1, y: 0 }}
                ...
                <p className="text-brand-text leading-relaxed">{v.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="text-3xl font-extrabold text-brand-navy mb-12">Our Journey</h2>
            ...
            {milestones.map((m, i) => (
              <motion.div key={i} initial={{ opacity: 0, x: -15 }} whileInView={{ opacity: 1, x: 0 }}
                ...
                <div className="flex-shrink-0 w-20 text-right">
                  <span className="text-xl font-extrabold text-brand">{m.year}</span>
                </div>
                <div className="w-px bg-brand/20 relative">
                  <div className="absolute top-1.5 -left-1.5 w-3.5 h-3.5 bg-brand rounded-full border-2 border-white" />
                </div>
                <div className="pb-4">
                  <p className="text-brand-text leading-relaxed">{m.text}</p>
                </div>
              </motion.div>
            ))}
          </div>
      ...
      <section className="py-16 bg-brand-cool-gray">
        <div className="max-w-4xl mx-auto px-6">
          <div className="bg-white rounded-xl p-8 sm:p-10 border border-gray-200">
            <h2 className="text-2xl font-extrabold text-brand-navy mb-4">Founded by Arvind</h2>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-6 grid sm:grid-cols-2 gap-8">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-lg font-bold text-brand-navy mb-2">Based in Coimbatore</h3>
              <p className="text-brand-text leading-relaxed">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-lg font-bold text-brand-navy mb-2">Our Vision</h3>
              <p className="text-brand-text leading-relaxed">
